      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-6">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
            Klassische Linie, erweitert oder Brazilian: Dauerhafte Haarreduktion mit Alexandrit (755 nm) & Diodenlaser (808 nm). 
            Fortschreitende Ausdünnung über die Sitzungsserie.*
          </p>
