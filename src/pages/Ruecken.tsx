  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        ...
        canonical={"https://laser-haarentfernung.hamburg/maenner/ruecken"}
        breadcrumb={[
          { name: 'Home', href: 'https://laser-haarentfernung.hamburg/', position: 1 },
          { name: 'Männer', href: 'https://laser-haarentfernung.hamburg/maenner', position: 2 },
          { name: 'Rücken', href: 'https://laser-haarentfernung.hamburg/maenner/ruecken', position: 3 }
        ]}
        service={{
          ...
          providerId: 'https://laser-haarentfernung.hamburg/#business',
        ...
        webPage={{
          ...
          websiteId: 'https://laser-haarentfernung.hamburg/#website'
        }}
        faq={[
